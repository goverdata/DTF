...
import com.github.dtf.rpc.server.AbstractServer.Connection;
//import com.github.dtf.rpc.server.AbstractServer.Listener.Reader;

/** Listens on the socket. Creates jobs for the handler threads*/
public class Listener extends Thread {
	public static final Log LOG = LogFactory.getLog(Listener.class);
	// FIXME
  private int readThreads = 10;                        // number of read threads
...
//      CommonConfigurationKeysPublic.IPC_SERVER_LISTEN_QUEUE_SIZE_DEFAULT);
  ...
  Server server;
  public Listener(Server server, InetAddress addr, int port, Configuration conf) throws IOException {
	this.server = server;
    ...
    AbstractServer.bind(acceptChannel.socket(), address, backlogLength, conf, portRangeConfig);
